...
public class Spikes extends Obstacle {
	...
	private Image spike1 = new Image("file:src/main/resources/image/spike1.png", 50, 50, true, true);
	private Image spike2 = new Image("file:src/main/resources/image/spike2.png", 50, 50, true, true);
	private Image spike3 = new Image("file:src/main/resources/image/spike3.png", 50, 50, true, true);
